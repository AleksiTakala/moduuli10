...
class Talo:
    ...
    def palohälytys(self):
        nykyhissi = self.hissilkm[2]
        print(f"Palohälytys kaikki hissit pohjakerrokseen")
        for i in range(len(self.hissilkm)):
            nykyhissi.siirry(self.alinkerros)
            print(f"Hissi {i+1} on kerroksessa {self.alinkerros}")
